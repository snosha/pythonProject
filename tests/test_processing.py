...
def test_filter_by_custom_state() -> None:
    """Тестирование фильтрации по указанному состоянию ('CANCELED')."""
    data: list[dict[str, str | int]] = [
        {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
        {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
        {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
...
def test_filter_by_missing_state() -> None:
    ...
    expected: list[dict[str, str | int]] = []
    assert filter_by_state(data, 'PENDING') == expected
